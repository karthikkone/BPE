...
public class CodeAnalyser {
	...
	public static void startScanSalesOrg() throws ConnectionException, IOException {

		Properties props = readSettings();
		try {
			/*
			 * DataStore.USERNAME = props.getProperty("sfdcUser"); DataStore.PASSWORD =
			 * props.getProperty("sfdcPassword");
			 * 
			 * 
			 * DataStore.AUTHENDPOINT = props.getProperty("authUrl");
			 */

			// System.out.println("Connecting to Salesforce org at URL: " +
			// DataStore.AUTHENDPOINT);
		...
		/*System.out.println("hello"+con.getUserInfo());
		System.exit(2);*/
...
//		System.out.println(con.getUserInfo().getUserTimeZone());
//		System.out.println("*******************");
//		System.out.println(con.getUserInfo().getUserType());
//		System.out.println("*******************");
//		System.out.println(con.getUserInfo().getSessionSecondsValid());
//		System.out.println("*******************");

	
//		System.out.println(con.getConfig().getRestEndpoint());
//		System.out.println(con.getConfig().getServiceEndpoint());
//		System.out.println(con.getConfig().getMaxResponseSize());
		...
		metadataList.add("PSRFSLAlignmentUtils");
		metadataList.add("ccAccountAccessAdminController");
		
		
		// Retrieving Apex Classes
		ArrayList<SObject> classes = ToolingOperations.retrieveIncrementalToolingComponents(con, "ApexClass",DataStore.METADATALIST );
		...
		for (SObject c : classes) {		
			...
			if (c instanceof ApexClass) {
				names.add(((ApexClass) c).getName());
				System.out.println(((ApexClass) c).getName());
